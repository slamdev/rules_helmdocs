...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@slamdev_rules_helmdocs//helmdocs:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.helmdocsinfo,
...
# By default all these toolchains are registered by the helmdocs_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:helmdocs_toolchain",
    toolchain_type = "@slamdev_rules_helmdocs//helmdocs:toolchain_type",
)
""".format(
            platform = platform,
